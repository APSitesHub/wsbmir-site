...
export const Timetable = ({ user, timetable }) => {
  ...
  const [marathonId, setMarathonId] = useState('80641');
  ...
  const changeTimetable = () => {
    setIsAnimated(true);
    setMarathonId(marathonId => (marathonId === '80641' ? '80640' : '80641'));
    setPersonalTimetable(
      personalTimetable =>
        (personalTimetable = timetable.find(timeline =>
          marathonId === '80641'
            ? '80640' === timeline.marathon
            : '80641' === timeline.marathon
        ))
    );
    setTimeout(() => {
      setIsAnimated(false);
        ...
        <TimetableBody>
          <TimetableWebinars>
            <TimetableWebinarsHead>
              ...
              >
                {marathonId === '80641' ? 'Logistics' : 'Kurs Przygotowawczy'}
              </TimetableLessonType>
